                    ...
                    <div class="row justify-content-center h-100">
                        <div class="col-lg-6 py-lg-5">
                            <div class="d-flex flex-column h-100 justify-content-center">
                                ...
                                <p class="text-muted mt-1 mb-4">Enter your email address to receive an OTP code for password reset.</p>
                                ...
                                <div class="mb-5">
                                    <form method="POST" action="{{ route('password.handleForgot') }}" class="authentication-form">
                                        ...
                                        <div class="mb-3 text-center d-grid">
                                            <button class="btn btn-soft-primary" type="submit">Get OTP</button>
                                        </div>
                                    </form>
