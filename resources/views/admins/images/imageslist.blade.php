                ...
                <div class="row">
                    ...
                    <div class="row g-3">
                        @forelse ($images as $image)
                            <div class="col-md-3">
                                <div
                                    class="card position-relative h-100 border {{ $image->is_featured ? 'border-success' : '' }}" style="max-height: 300px">
                                    {{-- Hiển thị ảnh --}}
                                    ...
                                    @if ($image->is_featured)
                                        <span class="badge bg-success position-absolute top-0 start-0 m-2">Ảnh nổi bật</span>
                                    @endif
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-4 pt-3 border-top">
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-rounded mb-0">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $images->previousPageUrl() }}" rel="prev" aria-label="Previous">
                                                <i class="bx bx-chevron-left"></i>
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($images->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $images->nextPageUrl() }}" rel="next" aria-label="Next">
